...
export default function Careers() {
  ...
  const validateForm = () => {
    ...
    if (form.location.length > 80) {
      toast.error("Location must be under 80 characters");
      return false;
    }

    if (form.graduation.length > 50) {
      toast.error("Graduation must be under 50 characters");
      return false;
    }
    ...
    if (countWords(form.skills) > 100) {
      toast.error("Skills must be under 100 words");
      return false;
    }
  ...
  return (
    ...
    <section className="min-h-screen bg-[#1a1a1a] text-white px-6 py-50">
  ...
  jobs.map((job, i) => (
    <motion.div
      ...
      className="p-6 border border-white/10 rounded-xl flex justify-between items-center"
    >
      <div>
          ...
          >
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                value={form.skills}
                onChange={handleChange}
                className="p-3 bg-black/30 border border-white/10 rounded-lg w-full"
              />
