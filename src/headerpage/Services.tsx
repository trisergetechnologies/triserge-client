  ...
  },
{
  ...
  desc: "Comprehensive, data-driven strategies to enhance search engine rankings, drive organic traffic, and maximize online visibility. We combine SEO optimization with performance marketing",
  icon: "📈",
},
  {
